...
export default async function HomePage() {
  const latestMacDownload = await getLatestMacDownload()
  const macDownloadUrl =
    latestMacDownload?.url || 'https://www.prdkit.xyz/downloads/darwin/PRDKit-1.0.0-arm64-mac.zip'
                    ...
                    <div className="hero-preview__canvas-stage">
                      <div className="hero-preview__preview-banner">
                        ...
                        <div className="hero-preview__preview-banner-hotkeys">
                          ...
                          <span
                            className="hero-preview__preview-banner-divider"
                            aria-hidden="true"
                          />
